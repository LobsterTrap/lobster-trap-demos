...
- an optional OpenRouter Gemma fallback model reference

## What's included

| File | Purpose |
|------|---------|
| `openclaw-agents.json` | Enables the `docs-checker` verification subagent and optional OpenRouter Gemma fallback |
...
If you also configure OpenRouter in the installer,
this bundle includes a fallback reference for:

- `openrouter/google/gemma-4-26B-A4B-it`

The bundle only names the model. You still need to provide OpenRouter auth in the installer deploy form.
